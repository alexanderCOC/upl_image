...
<body>
        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="<?php echo base_url('index.php/produk/data')?>">Data Produk</a></li>
 ...
 <div class="jumbotron col-md-6">
   <?php foreach($produk as $r) {?>
     <?=form_open_multipart('produk/proses_ubah/'.$r->id)?>
    <div class="form-group">
      <label for="nama">Nama :</label>
      <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Produk" id="nama" value="<?php echo $r->nama ?>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" name="stok" class="form-control" placeholder="Masukan Stok Produk" id="stok" value="<?php echo $r->stok ?>" required>
    </div>
    <div class="form-group">
